...
#создаем спрайты
packman = Player('ufo_3.png', 5, win_height - 80, 80, 80, 0, 0)
final_sprite = GameSprite('football.png', win_width - 85, win_height - 100, 80, 80)
 
monster1 = Enemy('dragon.png', win_width - 80, 150, 80, 80, 5)
monster2 = Enemy('dragon.png', win_width - 80, 230, 80, 80, 5)
